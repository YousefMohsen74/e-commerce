...
async function page({ params }) {
  ...
  return (
    <div className="min-h-screen px-40 w-full space-y-10">
      <div className="w-full flex space-x-10">
        <div className="relative w-1/2 bg-gray-100 h-80 flex justify-center items-center">
        ...
        <div className="w-1/2 flex flex-col space-y-5">
          ...
          <div className="flex space-x-3 items-center">
            ...
            <div className={product.availabilityStatus === "In Stock" ? "text-green-600" : "text-red-600"}>
